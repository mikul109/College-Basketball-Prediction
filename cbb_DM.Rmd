...
rocobj <- roc(test_data$WPERC_b, predicted_glm)
auc <- round(auc(test_data$WPERC_b, predicted_glm),4)
...
rocobj <- roc(test_data$WPERC_b, predicted_svm)
auc <- round(auc(test_data$WPERC_b, predicted_svm),4)
...
rocobj <- roc(test_data$WPERC_b, predicted_tree)
auc <- round(auc(test_data$WPERC_b, predicted_tree),4)
...
rocobj <- roc(test_data$WPERC_b, predicted_knn)
auc <- round(auc(test_data$WPERC_b, predicted_knn),4)
...
rocobj <- roc(factor(train_labs + 1), predicted_xgb)
auc <- round(auc(factor(train_labs + 1), predicted_xgb),4)
